 ...
 * до c95a6f48.
 *
 * Версия b288ba04 записывалась ревизией HyScan для "корейцев" от 01.04.2020.
 *
...
/* Функция обновляет формат данных параметров проекта с версии c95a6f48
 * до 8c1d17c8.
 *
 * Версия c95a6f48 записывалась ревизией HyScan для "корейцев" от 04.04.2020.
 *
